      ...
      <div className="rounded-3xl w-full h-full">
        <ul className="relative rounded-3xl w-full h-full cards-stack">
          ...
          <li className="absolute flex w-full h-full pr-4 pt-4 transition-transform duration-200">
            <div className="rounded-3xl bg-white w-full h-full shadow p-4 flex flex-col">
              {example && (
                <span className="text-lg text-gray-400 font-sans text-center whitespace-pre-line">
                  {example}
                </span>
              )}
            </div>
