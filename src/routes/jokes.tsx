...
function JokesPage() {
  return (
    <div className="flex flex-col gap-6 w-full md:w-3/4 h-full px-3 py-6 items-center justify-center">
          ...
          <CardStack.Back>
            <div className="h-full py-6 px-4 md:px-12 gap-8 flex flex-col items-center justify-evenly">
              <div className="flex flex-col gap-2">
                ...
                <span className="font-sans text-lg text-center">Jonathan</span>
              </div>
            </div>
          </CardStack.Back>
        </CardStack.Item>
